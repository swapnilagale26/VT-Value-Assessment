  ...
  archetypeTextmiddleDescription: {
    ...
    mars: [
      ...
      },
      {
        ...
        discription:
          "Mars, in its shadow form, can manifest as unchecked aggression and impulsiveness. Their courage and determination may turn into a tendency to dominate and control. This can lead to a lack of patience, a quick temper, and a propensity to engage in conflicts, sometimes needlessly. Their assertiveness may become destructiveness, as they bulldoze over other's thoughts and feelings in pursuit of their goals.",
      },
      {
...
const outerLevelArctypeText = {
  ...
  archetypeTextSecond:
    "which has emerged as the most influential among the 12 selected values in the second round. This archetype acts as a profound guiding star, influencing your intellectual and adaptive prowess, and shaping your unique perspective within the broader canvas of human experience.",
};
...
const innerLevelArctypeText = {
  ...
  archetypeTextSecond:
    "the highest-scoring archetype for the third round of 6 selected values. This archetype acts as the inner muse that inspires your most personal expressions and infuses your life with a unique, authentic vitality.",
};
